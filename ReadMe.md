...
+------+------+-----------------------------------------------+
       ...
       v                           v                        v
+-------------------+    +-------------------+    +------------------------+
|    Add Student    |    |   Update Grade    |    |   Update Attendance    |
+---------+---------+    +---------+---------+    +-----------+------------+
          |                      |                          |
          v                      v                          v
+-------------------+   +-------------------+      +------------------------+
|   Input ID        |   |  Find Student?    |      |   Find Student?        |
+---------+---------+   +---------+---------+      +-----------+------------+
          | Yes                | Yes                      | Yes
          v                    v                          v
+-------------------+   +-----------------------+   +------------------------+
| Input Name        |   | Input Assignment      |   | Input Attendance       |
| Init Grades/Att   |   | Score & Weight        |   | (Attended & Total)     |
+---------+---------+   +-----------+-----------+   +-----------+------------+
          |                         |                          |
          v                         v                          v
+-------------------+   +-----------------------+   +------------------------+
